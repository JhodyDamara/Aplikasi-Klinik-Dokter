...
Public Class Laporan_Pasien
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "klinik.Laporan_Pasien.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporan_Pasien
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Laporan_Pasien = New Laporan_Pasien
        rpt.Site = Me.Site
        Return rpt
    End Function
