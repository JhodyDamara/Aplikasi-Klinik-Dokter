...
Public Class Laporan_Perawat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "klinik.Laporan_Perawat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporan_Perawat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Laporan_Perawat = New Laporan_Perawat
        rpt.Site = Me.Site
        Return rpt
    End Function
