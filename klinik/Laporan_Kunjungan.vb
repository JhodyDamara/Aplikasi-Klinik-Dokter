...
Public Class Laporan_Kunjungan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "klinik.Laporan_Kunjungan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporan_Kunjungan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Laporan_Kunjungan = New Laporan_Kunjungan
        rpt.Site = Me.Site
        Return rpt
    End Function
