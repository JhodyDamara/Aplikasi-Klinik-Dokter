...
Public Class Laporan_Tindakan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "klinik.Laporan_Tindakan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporan_Tindakan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Laporan_Tindakan = New Laporan_Tindakan
        rpt.Site = Me.Site
        Return rpt
    End Function
