...
Public Class Cetak_Pendaftaran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "klinik.Cetak_Pendaftaran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCetak_Pendaftaran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cetak_Pendaftaran = New Cetak_Pendaftaran
        rpt.Site = Me.Site
        Return rpt
    End Function
